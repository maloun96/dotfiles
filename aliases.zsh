...
alias roombricks="cd /Users/victormalai/www/roombriks-desktop && pstorm . && npm run dev"
alias roombricksapi="cd /Users/victormalai/www/roombricks && php artisan serve"
